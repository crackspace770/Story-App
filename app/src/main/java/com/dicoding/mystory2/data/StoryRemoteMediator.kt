...
import com.dicoding.mystory2.database.RemoteKeys
import com.dicoding.mystory2.database.StoryDatabase
import com.dicoding.mystory2.ui.main.ListStoryItem


@OptIn(ExperimentalPagingApi::class)
class StoryRemoteMediator(private val database: StoryDatabase, private val apiService: ApiService, private val context: Context) : RemoteMediator<Int, ListStoryItem>() {
    ...
    override suspend fun load(
        ...
        return try {
            val responseData = apiService.getPageStories(page, state.config.pageSize,sharedPreference?.getPreferenceString("token"))
